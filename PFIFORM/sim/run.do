...
add wave -color green tb_PFIFORM/PFIFORM_instance/PopEnable
add wave -color red tb_PFIFORM/PFIFORM_instance/i_core_clk
add wave -unsigned -color red tb_PFIFORM/PFIFORM_instance/JoinAmount
add wave -unsigned -color green tb_PFIFORM/PFIFORM_instance/PopAmount
add wave -color orange tb_PFIFORM/PFIFORM_instance/JoinEnable
add wave -color orange tb_PFIFORM/PFIFORM_instance/PopPermit
